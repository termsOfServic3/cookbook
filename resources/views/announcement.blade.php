...
<div class="bg-white xl:w-1/2 mx-auto rounded-lg shadow-md mt-4 overflow-hidden">
    ...
    <div class="text-gray-600 px-5 py-5">
        ...
        <p class="mt-6 mx-auto">
            <a href="{{$announcement->buttonLink}}" class="bg-purple-800 text-white
            inline-block rounded-xl font-semibold px-8 py-4" style="background:
             {{$announcement->buttonColor}}">{{$announcement->buttonText}}</a>
        </p>
